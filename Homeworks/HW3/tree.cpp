...
int countIncludes(const string a1[], int n1, const string a2[], int n2)
{
	...
	int count = countIncludes(a1 + 1, n1 - 1, a2, n2);
...
//{
//	string a[] = { "3","6", "5", "8", "1"};
//	string a1[] = {"h", "c", "i", "d", "j", "a", "g", "f", "m", "b", "e", "k", "l", };
//	string a2[] = {"stan", "kyle", "cartman", "kenny", "kyle", "cartman", "butters"};
//	string a3[] = { "stan", "kenny", "cartman"  }; //1
//	string a4[] = { "stan", "cartman", "butters" }; //2
//	string a5[] = { "kenny", "stan", "cartman" }; //0
//	string a6[] = { "kyle", "cartman", "butters" }; //3
//
//	order(a, 5);
//	order(a1, 13);
//	for (int i = 0; i < 5; i++)
...
//	cout << endl;
//
//	assert(countIncludes(a2, 7, a3, 3) == 1);
//	assert(countIncludes(a2, 7, a4, 3) == 2);
//	assert(countIncludes(a2, 7, a5, 3) == 0);
//	assert(countIncludes(a2, 7, a6, 3) == 3);
//	assert(countIncludes(a2, 7, a6, 1) == 2);
//}