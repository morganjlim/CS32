...
void test()
{
	...
	assert(s4.find(42) == -1);
	assert(s4.insert(42) == 0);
	assert(s4.size() == 1 && s4.find(42) == 0);
	...
	//Sequence s4;
	//s4.insert(0, "lavash");
	//s4.insert(0, "tortilla");
	//assert(s4.size() == 2);
	//ItemType y = "injera";
	//assert(s4.get(0, y) && y == "tortilla");
	//assert(s4.get(1, y) && y == "lavash");
	...
	//Sequence s5(s3);
	//assert(s5.find("pita") == 0 && s5.find("") == 1 && s5.find("matzo") == 2);

	//s5 = s2;
	//assert(s5.size() == 2 && s5.find("focaccia") == 0 && s5.find("paratha") == 1);
	//assert(s2.size() == 2 && s2.find("focaccia") == 0 && s2.find("paratha") == 1);
